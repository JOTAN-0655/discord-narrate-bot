...
import narrate_bot.Main;
import narrate_bot.config_manager.Config_Manager;
import narrate_bot.config_manager.Dictionary_Manage;
import narrate_bot.config_manager.Name_Read_Mode_Manager;
...
import narrate_bot.config_manager.Name_Read_Mode_Manager.Name_Read_Mode;
import narrate_bot.discord.lavaplayer.GuildMusicManager;
...
public class Discord_Events extends ListenerAdapter implements Listener{
	...
	public void solve_command(MessageReceivedEvent e) {
		...
		if(command_args[1].equalsIgnoreCase("help")) {
			textchannel.sendMessageEmbeds(get_Command_List()).complete();
